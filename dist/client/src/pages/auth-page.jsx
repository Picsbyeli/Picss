...
export default function AuthPage() {
    ...
    return (<div className="flex flex-col md:flex-row min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-cyan-50">
        ...
        <Card className="w-full max-w-md bg-white/90 backdrop-blur-sm shadow-2xl border-2 border-purple-200 rounded-3xl">
          ...
          <CardContent>
            ...
            <div className="space-y-4 mb-6">
              <Button onClick={handleGoogleSignIn} className="w-full bg-white text-gray-700 border border-gray-300 hover:bg-gray-50" variant="outline">
          ...
          <CardFooter className="flex flex-col space-y-4">
            ...
            <Button variant="outline" className="w-full" onClick={playAsGuest}>
              Play as Guest
            </Button>
            <p className="text-center text-sm text-muted-foreground">
              {activeTab === "login" ? ("Don't have an account? Click Register above.") : ("Already have an account? Click Login above.")}
            </p>
          </CardFooter>
        </Card>
      </div>
