...
export default function ProfilePage() {
    ...
    const getCategoryStyles = (colorClass) => {
        switch (colorClass) {
    ...
    return (<div className="container max-w-5xl px-4 md:px-6 py-6 md:py-12">
      <div className="mb-8">
      ...
      <div className="flex justify-center mb-8">
        <CustomAvatarDisplay config={user.avatarConfig ? JSON.parse(user.avatarConfig) : null} username={user.username} profileImageUrl={user.profileImageUrl} size={120} className="shadow-lg"/>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={(value) => {
        ...
        <TabsContent value="favorites">
          ...
          <div className="border rounded-lg p-4">
            ...
            {isLoadingFavorites ? (<div className="flex justify-center py-12">
                <Loader2 className="h-8 w-8 animate-spin text-primary"/>
              </div>) : !favorites || favorites.length === 0 ? (<div className="text-center py-12 text-muted-foreground">
                ...
                {Array.isArray(favorites) && favorites.map((favorite) => (<Card key={favorite.id} className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => handleRiddleClick(favorite.riddle.id)}>
        ...
        <TabsContent value="history">
          ...
          <div className="border rounded-lg p-4">
            ...
            {isLoadingProgress ? (<div className="flex justify-center py-12">
                <Loader2 className="h-8 w-8 animate-spin text-primary"/>
              </div>) : (!solvedRiddles.length && !attemptedRiddles.length) ? (<div className="text-center py-12 text-muted-foreground">
                ...
                {solvedRiddles.length > 0 && (<div>
                    <h3 className="text-lg font-semibold mb-4 flex items-center">
                      <CheckCircle className="h-5 w-5 mr-2 text-green-500"/>
                      Solved Riddles
                    </h3>
                    <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                      {solvedRiddles.map((progress) => (<Card key={progress.id} className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => handleRiddleClick(progress.riddleId)}>
                          <CardHeader className="p-4 pb-2">
                            <div className="flex justify-between">
                          ...
                          <CardContent className="pt-0 pb-4 px-4">
                            {progress.hintsUsed && progress.hintsUsed > 0 && (<div className="text-xs text-muted-foreground">
                ...
                {attemptedRiddles.length > 0 && (<div>
                    <h3 className="text-lg font-semibold mb-4 flex items-center">
                      <XCircle className="h-5 w-5 mr-2 text-amber-500"/>
                      Attempted Riddles
                    </h3>
                    <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                      {attemptedRiddles.map((progress) => (<Card key={progress.id} className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => handleRiddleClick(progress.riddleId)}>
                          <CardHeader className="p-4 pb-2">
                            <div className="flex justify-between">
                              <Badge className={getCategoryStyles(progress.riddle.category.colorClass)}>
                                {progress.riddle.category.name}
        ...
        <TabsContent value="picture">
          ...
          <div className="border rounded-lg p-6">
            ...
            <ProfilePictureUpload currentImageUrl={user.profileImageUrl} username={user.username} onUploadComplete={(imageUrl) => {
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    <div className="grid gap-6 grid-cols-1 md:grid-cols-2">
                      <FormField control={form.control} name="theme" render={({ field }) => (<FormItem>
                    ...
                    <FormField control={form.control} name="notificationsEnabled" render={({ field }) => (<FormItem className="flex flex-row items-center justify-between space-y-0 rounded-md border p-4">
