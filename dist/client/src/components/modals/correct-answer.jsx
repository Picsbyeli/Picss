...
export const CorrectAnswerModal = ({ isOpen, onClose, riddleAnswer, explanation, timeToSolve, pointsEarned, onNextRiddle, onBackToMenu }) => {
      ...
      <DialogContent className="sm:max-w-md mx-4 rounded-xl shadow-xl p-6 fade-in" onPointerDownOutside={(e) => e.preventDefault()}>
        <div className="text-center">
          ...
          <div className="flex space-x-3">
            <Button onClick={onBackToMenu} variant="outline" className="flex-1 bg-light-gray hover:bg-light-gray/80 text-dark font-medium py-3 rounded-lg transition duration-200">
              Back to Menu
            </Button>
            <Button onClick={onNextRiddle} className="flex-1 bg-primary hover:bg-primary/90 text-white font-medium py-3 rounded-lg transition duration-200">
              Next Riddle
            </Button>
          </div>
