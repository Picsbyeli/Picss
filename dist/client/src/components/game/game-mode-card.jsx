...
export default function GameModeCard({ title, description, icon, backgroundColor, linkTo, difficulty }) {
    return (<Card className="overflow-hidden transition-all duration-300 hover:shadow-lg">
      ...
      <CardHeader className="pb-2">
        <div className="flex justify-between items-center">
          ...
          {difficulty && (<span className="text-xs px-2 py-1 bg-gray-100 rounded-full">
              {difficulty}
            </span>)}
        </div>
