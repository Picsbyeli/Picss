      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-3">
          <div className="border rounded-lg overflow-hidden">
            <img src={rebusPuzzlesImage} alt="Rebus Puzzles" className="w-full h-auto object-contain"/>
          </div>
        ...
        <div className="space-y-3">
          <div className="border rounded-lg overflow-hidden">
            <img src={puzzleGridImage} alt="Word Brain Teasers" className="w-full h-auto object-contain"/>
          </div>
