...
export default function CustomAvatarDisplay({ config, username, profileImageUrl, size = 40, className = "" }) {
    ...
    return (<div className={className}>
      ...
      {profileImageUrl ? (<Avatar style={{ width: size, height: size }}>
          <AvatarImage src={profileImageUrl} alt={username}/>
          <AvatarFallback className="bg-gradient-to-br from-purple-500 to-pink-500 text-white">
            {getInitials(username)}
          </AvatarFallback>
        </Avatar>) : config ? (<CustomAvatar config={avatarConfig} size={size}/>) : (<Avatar style={{ width: size, height: size }}>
          <AvatarFallback className="bg-gradient-to-br from-purple-500 to-pink-500 text-white">
            {getInitials(username)}
          </AvatarFallback>
        </Avatar>)}
