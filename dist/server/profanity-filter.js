...
class CustomFilter {
    constructor() {
        ...
        this.addWords('shit', 'ass', 'fuck', 'cunt', 'slut', 'bitch', 'whore', 'bastard', 'pussy', 'dick', 'cocksucker', 'motherfucker', 'damn', 'hell', 'retard', 'fag', 'faggot', 'homo', 'nigger', 'nigga', 'spic', 'wetback', 'chink', 'dyke', 'kike', 'tranny', 'nazi', 'piss');
    }
    addWords(...words) {
